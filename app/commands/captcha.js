...
class verify {
    ...
    async execute(message, args) {
        if (message.guild.id !== CONFIG.HSE_MANAGER_GUILD || message.author.bot || message.channel.id !== CONFIG.VERIFICATION_CHANNEL) return;
        ...
        captchaSystem(message.member, message);
